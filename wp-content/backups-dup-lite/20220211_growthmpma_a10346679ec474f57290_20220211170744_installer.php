...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220211_growthmpma_a10346679ec474f57290_20220211170744_archive.zip';
	const ARCHIVE_SIZE		 = '62420804';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'a103466-11170744';
    const SECONDARY_PACKAGE_HASH = '07fbdc1-11170744';
	const VERSION			 = '1.4.4';
